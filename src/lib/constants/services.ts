export const services = [
	{
		...
		rightTopContent: [
			...
			'AppExchange / AppSource publishing',
			'Managed support'
		],
		...
		rightBottomContent: [
			...
			'Rapid deployment using pre-built frameworks'
		]
	},
...

	{
		...
		rightTopTitle: 'What you get',
		rightTopContent: ['AI-generated test cases', 'UX validation', 'Performance/security testing'],
		rightBottomTitle: 'Why DAAF',
		rightBottomContent: [
			'Low-code test harness',
